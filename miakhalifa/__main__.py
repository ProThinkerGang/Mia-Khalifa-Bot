...
_Maintained by_ [{#ProThinkerGang}](https://t.me/prothinkers)
"""
...
SOURCE_STRING = """
⚡I'm built in python3 whose Source Codes are Fully Open !!
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/87681ee55fd89278f9199.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🤝Help",callback_data="help_back"),InlineKeyboardButton(text="🛡Creator🛡",url="https://t.me/ProThinkers")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚜️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="🛡Contact Creator",url="https://t.me/ProThinkers")]]))
        return
